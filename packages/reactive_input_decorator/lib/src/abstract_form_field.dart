...
class ReactiveFormFieldAbstract<ModelDataType, ViewDataType>
    extends StatefulWidget {
  /// Function that returns the widget representing this form field. It is
  /// passed the form field state as input, containing the current value and
  /// validation state of this field.
  final ReactiveFormFieldAbstractBuilder<ModelDataType, ViewDataType> _builder;

  /// The name of the [FormControl] that is bound to this widget.
  final String? formControlName;

  /// The control that is bound to this widget.
  final AbstractControl<ModelDataType>? formControl;
  ...
  // final ControlValueAccessorAbstract<ModelDataType, ViewDataType>? valueAccessor;

  /// Gets the callback that define when to show errors in UI.
  final ShowErrorsAbstractFunction<ModelDataType>? showErrors;

  /// TODO: add documentation
  final FocusNode? focusNode;

  /// Creates an instance of the [ReactiveFormFieldAbstract].
  ///
  /// Must provide a [forControlName] or a [formControl] but not both
  /// at the same time.
  ///
  /// The [builder] arguments are required.
  const ReactiveFormFieldAbstract({
    super.key,
    this.formControl,
  ...
  ReactiveFormFieldAbstractState<ModelDataType, ViewDataType> createState() =>
      ReactiveFormFieldAbstractState<ModelDataType, ViewDataType>();
}

/// Represents the state of the [ReactiveFormFieldAbstract] stateful widget.
class ReactiveFormFieldAbstractState<ModelDataType, ViewDataType>
    extends State<ReactiveFormFieldAbstract<ModelDataType, ViewDataType>> {
  /// The [FormControl] that is bound to this state.
  late AbstractControl<ModelDataType> control;
  late StreamSubscription<ControlStatus> _statusChangesSubscription;
  late StreamSubscription<bool> _touchChangesSubscription;

  // late ControlValueAccessorAbstract<ModelDataType, ViewDataType> _valueAccessor;
  ...
  /// Gets the widget control value accessor
  // ControlValueAccessorAbstract<ModelDataType, ViewDataType> get valueAccessor =>
  //     _valueAccessor;
  ...
  // @protected
  // @visibleForTesting
  // ControlValueAccessorAbstract<ModelDataType, ViewDataType> selectValueAccessor() {
  //   return DefaultValueAccessorAbstract();
  // }
  ...
  // ControlValueAccessorAbstract<ModelDataType, ViewDataType> _resolveValueAccessor() {
  //   return widget.valueAccessor ?? selectValueAccessor();
  // }

  AbstractControl<ModelDataType> _resolveFormControl() {
    ...
    if (control is! AbstractControl<ModelDataType>) {
      throw Exception(control);
    }
  ...
  //   }
  //
  //   return control as AbstractControl<ModelDataType>;
  // }
